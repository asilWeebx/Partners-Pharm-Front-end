...
import { mockDiseases, mockProducts, mockFounders, mockPartners } from './data/mockData';
...
function LandingPage({ showCallModal, setShowCallModal }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <CatalogSection products={mockProducts} setShowCallModal={setShowCallModal} />
    ...
    <Router>
      <Routes>
        ...
        <Route path="/admin/partners" element={
          ...
          <Route index element={<div className="text-2xl font-bold">Partners Page (Coming Soon)</div>} />
        </Route>
        ...
        <Route path="/admin/diseases" element={
          ...
          <Route index element={<div className="text-2xl font-bold">Diseases Page (Coming Soon)</div>} />
        </Route>
